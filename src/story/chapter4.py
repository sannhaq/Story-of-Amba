def chapter_4(nama_karakter):
    return[
        f"Dengan hati berdebar,",
        f"{nama_karakter} dan Arfan melangkah lebih dalam ke dalam kuil yang terletak di bawah reruntuhan.",
        f"Suasana semakin gelap dan mencekam,",
        f"hanya diterangi oleh cahaya samar dari obor yang dibawa oleh {nama_karakter}.",
        "Setiap langkah mereka disertai dengan suara-suara aneh yang datang entah dari mana,",
        "seolah-olah kuil ini hidup dan mengawasi mereka."
        "Dinding-dinding kuil itu dipenuhi ukiran-ukiran kuno yang menceritakan kisah tragis",
        " dan peringatan bagi siapa pun yang berani menjelajah lebih jauh.",
        "Kuil ini menyimpan rahasia yang sangat berbahaya, dan semakin mereka mendalaminya,",
        "semakin jelas bahwa harta karun yang mereka cari bukanlah satu-satunya hal yang tersembunyi di sini."
    ]

def chapter_4_event_1(nama_karakter):
    return[
        f"Setelah menuruni beberapa anak tangga yang berdebu,",
        f"{nama_karakter} dan Arfan tiba di sebuah pintu besar dari logam kuno.",
        f"Pintu itu tampak kokoh,",
        "dihiasi simbol-simbol yang sama seperti yang mereka temui di sepanjang jalan.",
        "Tetapi, tidak ada pegangan atau kunci yang tampak di permukaannya.",
        "Hanya ada sebuah batu besar di samping pintu,",
        "dengan ukiran berbentuk tangan yang tampak mengundang untuk disentuh."
    ]

def chapter_4_event_2(nama_karakter):
    return[
...
def chapter_4_event_3(nama_karakter):
    return[
        ...
        f"dan {nama_karakter} merasa bahwa mereka semakin mendekati sesuatu yang sangat berbahaya."
    ]

def chapter_4_event_4(nama_karakter):
    return[
...
def chapter_4_event_5(nama_karakter):
    return[
        ...
        "dan bagian dari jalan tersebut runtuh, hampir menjerat mereka ke dalam jurang."
    ]
...
def chapter_4_event_6(nama_karakter):
    return[
        ...
        "dan jelas bahwa ia adalah penjaga dari sesuatu yang sangat penting di kuil ini."
    ]
...
def chapter_4_event_8(nama_karakter):
    return[
        ...
        "mungkin petunjuk untuk menemukan kunci tersebut."
    ]
...
def chapter_4_event_10(nama_karakter):
    return[
        ...
        f"{nama_karakter} merasakan bahwa ini adalah artefak yang Alaric tulis dalam suratnya.",
        "Tetapi, ada sesuatu yang sangat salah dengan benda itu."
    ]